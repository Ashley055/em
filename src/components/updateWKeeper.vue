<template>
	<div class="page">
	 	...
	 	<div class="page-content">
	 		        ...
	 		        <div class="item-inner">
    	         		<div class="item-title label"><span class="color-red">*</span>姓         名</div>
    	          		<div class="item-input">
    	            		<input class="kname" :name="'kname'+ (index + 1)" :value="wkeeper.managerName" type="text" placeholder="请输入姓名">
    	          		</div>
    	        	</div>
	 		      </li>
	 		      <li>
	    	    		<div class="item-content">
		    	        	<div class="item-inner">
		    	         		<div class="item-title label">身份证号</div>
		    	          		<div class="item-input">
		    	            		<input class="kidCard" :name="'kidCard' + (index + 1)" :value="wkeeper.managerIdCard" type="text" maxlength="18" onkeyup="this.value=this.value.replace(/[^\d\X]/g,'');" placeholder="请输入身份证号">
		    	          		</div>
		    	        	</div>
		    	        </div>
		    	    </li>
	    	    		...
	    	    		<div class="item-content">
		    	        	<div class="item-inner">
		    	         		<div class="item-title label">联系电话</div>
		    	          		<div class="item-input">
		    	            		<input class="kphone" :name="'kphone' + (index + 1)" :value="wkeeper.managerPhone" maxlength="13" onkeyup="this.value=this.value.replace(/[^\d\-]/g,'');"  type="text" placeholder="请输入联系电话">
		    	          		</div>
		    	        	</div>
		    	        </div>
		    	    </li>
		    ...
		    <p class="btn-wrap bg-white"><a href="javascript:void(0)" @click="updatas" class="button active b-next">提交</a></p>
	 	</div>
	</div>
</template>
...
import {entAjax} from '@/common/js/ajax'
	export default{
		...
		created(){
			this.wkeepers = window.warehouseManagers
		...
		methods: {
		  ...
		  updatas () {
		    ...
		    var param = {
		    	...
		    	warehouseId: window.basicId.warehouseId,
		    	...
		    	pathVar: '/warehouseInfo/update.do',
		    };
		  ...
		  deleteInfo(index){
  		  	var _self = this
  		  	f7App.confirm('确认删除该仓管员?', 
  		  	   function () {
  		  	     _self.wkeepers.splice(index, index + 1)
  		  	   },
  		  	   function () {
